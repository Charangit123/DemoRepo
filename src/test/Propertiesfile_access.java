...
import com.myProject.WebdriverManager;

import io.github.bonigarcia.wdm.WebDriverManager;

public class Propertiesfile_access {
	...
	public static void main(String[] args) throws Throwable {
		...
		FileInputStream ip= new FileInputStream
				("C:\\Users\\user1\\eclipse-workspace\\myProject\\src\\test\\java\\naveenSelenium\\testfile.properties");
		prop.load(ip);
